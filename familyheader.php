...
<head>
    ...
    <!-- PLUGINS STYLES-->
    <link href="./dist/assets/vendors/DataTables/datatables.min.css" rel="stylesheet" />
    <!-- THEME STYLES-->
    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            <div class="page-brand">
                <a class="link" href="#">
                    <span class="brand">MAHALLU
                        <span class="brand-tip"></span>
                    </span>
                    <span class="brand-mini">M</span>
                </a>
            </div>
            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">Welcome</div><small>User</small></div>
                </div>
                ...
                >
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-bookmark"></i>
                            <span class="nav-label">My Account</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="viewnoti.php">Notifications</a>
                            </li>
                             <li>
                                <a href="functionregistration.php">Function Requests</a>
                            </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">My Panel</h1>
                <ol class="breadcrumb">
